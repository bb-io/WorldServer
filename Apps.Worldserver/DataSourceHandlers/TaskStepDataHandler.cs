...
public class TaskStepDataHandler : WorldserverInvocable, IAsyncDataSourceHandler
{
    private GetTaskRequest TaskRequest { get; set; }

    public TaskStepDataHandler(InvocationContext invocationContext, [ActionParameter] GetTaskRequest taskRequest) : base(invocationContext)
    {
